...
String apiKey = "KGKXH4LC3S3DMVCA";     //  Enter your Write API key here
const char *ssid =  "JioFi3_C547CB";     // Enter your WiFi Name
const char *pass =  "ycnd66w3ar"; // Enter your WiFi Password
...
void loop() {
  // put your main code here, to run repeatedly:
    ...
    int AQI = analogRead(aqsensor); //read MQ135 analog outputs at A0 and store it in ppm

  Serial.print("Air Quality: ");  //print message in serail monitor
  Serial.println(AQI);            //print value of ppm in serial monitor

  lcd.setCursor(0,0);             // set cursor of lcd to 1st row and 1st column
  lcd.print("Air Quality: ");      // print message on lcd
  lcd.print(AQI);                 // print value of MQ135
  delay(1000);
